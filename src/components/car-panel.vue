<template>
  <li class="nav-cart">
    <a href="javascript:;" @mouseenter="showCar" @mouseleave="hideCar" class="ball-rect">购物车</a>
    <!--根据class改变颜色-->
...
<!--              <a ng-href="http://www.smartisan.com/shop/#/cart" class="nav-cart-btn" href="http://www.smartisan.com/shop/#/cart">去购物车</a>-->
    ...
    <el-dialog title="提示" :visible="visible" width="300px" @close="closePrompt()">
      <div>当前数量超过最大数</div>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="closePrompt()">确定</el-button>
      </div>
    </el-dialog>
    <transition
      name="ball"
...
<style scoped>
  .ball-enter-active {
    transition: .5s cubic-bezier(.32,.98,.72,1.32);
  }
