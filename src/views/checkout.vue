          ...
          <div class="box-inner js-checkout-address-panel ">
            <div class="address-common-table js-multiple-address-panel">
              <ul class="address-item-list clear js-address-item-list">
                <li class="js-choose-address" @click="chooseReceive(index)" :class="{'selected-address-item': receiveIndex === index}" v-for="(receive, index) in receiveInfo" v-bind:key="index">
...
<!--              </label>-->
              <el-radio v-model="invoice" label="1">个人</el-radio>
              <el-radio v-model="invoice" label="2">单位</el-radio>
            </div>
            <div class="module-form-row form-item fn-hide js-invoice-title" v-if="invoice==='2'">
              <div class="module-form-item-wrapper no-icon small-item">
                <i v-show="!invoiceName">请填写公司发票抬头</i>
                <input type="text" class="js-verify" v-model="invoiceName">
              </div>
            </div>
          </div>
        ...
        methods: {
            ...
            submitOrderHandle() {
                let data = {
                    ...
                    receiveInfo: this.receiveInfo[this.receiveIndex],
                    isPay: false
                }
