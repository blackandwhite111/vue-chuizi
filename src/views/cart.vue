      ...
      <div class="cart-box">
                  ...
                  <div class="cart-items">
                    ...
                    <div class="item-cols-num">
                      <div class="select js-select-quantity">
                        <span class="down" :class="{'down-disabled': item.count<=1}" @click="subCarPanelData(item.sku_id)">-</span>
        ...
        <div class="cart-bottom-bg fix-bottom" v-if="count>0">
          <div class="cart-bar-operation">
            <div>
              <div class="choose-all js-choose-all" @click="allCheckGoods()">
                <span class="blue-checkbox-new" :class="{'checkbox-on': allChecked}"><a></a></span>
                全选
              </div>
          ...
          <div class="shipping">
            ...
            <router-link tag="span" to="/checkout"  class="jianguo-blue-main-btn big-main-btn js-checkout" :class="{'disabled-btn': checkedCount<1}"><a>现在结算</a></router-link>
          </div>
        </div>
      </div>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            allCheckGoods() {
                this.$store.commit('allCheckGoods', this.allChecked)
            },
            delCheckGoods() {
