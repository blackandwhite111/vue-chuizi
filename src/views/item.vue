      ...
      <div class="item-box">
        <div class="gallery-wrapper">
          <div class="gallery">
            ...
            <div class="thumb">
              <ul>
                <li :class="{'on': index === imageIndex}" v-for="(img, index) in itemInfo.ali_images" v-bind:key="index"><img :src="img"></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="sku-dynamic-params-panel">
            <div class="sku-dynamic-params clear">
              ...
              <ul class="params-colors">
                <li :class="{'cur': color.id === $route.query.itemId}" v-for="(color, index) in itemInfo.sku_list" v-bind:key="index">
...
<script>
  import itemsData from '@/lib/newItemsData'
    export default {
        ...
        methods: {
            addCarPanelHandle() {
                this.$store.commit('addCarPanelData', {info: this.itemInfo, count: this.count})
            },
            addCount() {
                this.count++
